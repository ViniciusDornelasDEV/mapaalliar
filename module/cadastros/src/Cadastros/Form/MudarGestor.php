   ...
   public function __construct($name, $serviceLocator)
    {
        ...
        //lider_atual
        $this->_addDropdown('lider_imediato', '* Gestor atual:', true, array('' => '-- Selecione --'), 'trocarLider(this.value);');

        //novo_lider
        $this->_addDropdown('novo_lider', '* Novo Gestor:', true, array('' => '-- Selecione --'));
